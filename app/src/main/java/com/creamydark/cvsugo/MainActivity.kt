...
@Composable
private fun DemoNotifierDialog(){
    ...
    if (show) {
        AlertDialog(
            ...
            text = { Text(text = "This is a demo application created solely for demonstration purposes and is not officially affiliated with Cavite State University.") },
